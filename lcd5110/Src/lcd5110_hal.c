...
//! TODO: optimize! Slow!
void LCD5110_fill_region(int x0, int y0, int w, int h, int color,
...
void LCD5110_drawBitmap(int x, int y, const unsigned char* bitmap, int cols,
	int rows, int invert, LCD5110_conf* lcd_conf)
    {
